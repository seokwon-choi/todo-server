...
class TodoControllerTest {
    ...
    private TodoMobel expected;

    @BeforeEach
    void setup(){
        this.expected = new TodoMobel();
    ...
    void create() throws Exception {
        when(this.todoService.add(any(TodoRequest.class))).then((i) -> {
           ...
           return new TodoMobel(this.expected.getId(),request.getTitle(), this.expected.getOrder(), this.expected.getCompleted());
